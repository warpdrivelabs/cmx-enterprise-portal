...
export const PORTAL_TAB_OVERFLOW_STYLES = `
  .portal-tab-overflow-wrap {
    ...
    margin-left: 2px;
    border-left: 1px solid var(--neo-border-subtle, var(--sapGroup_TitleBorderColor, rgba(0, 0, 0, 0.08)));
    background: linear-gradient(
      90deg,
      transparent 0%,
      color-mix(in srgb, var(--neo-cyan, #00b4d8) 6%, var(--portal-tab-row-bg, var(--sapObjectHeader_Background, #fff))) 14px
    );
  }
  .portal-tab-overflow-trigger {
    ...
    cursor: pointer;
    color: var(--neo-cyan, var(--sapContent_IconColor, #0854a0));
    background: color-mix(in srgb, var(--neo-cyan, #00b4d8) 8%, var(--sapButton_Lite_Background, transparent));
    box-shadow: inset 0 0 0 1px color-mix(in srgb, var(--neo-cyan, #00b4d8) 22%, transparent);
  ...
  .portal-tab-overflow-trigger:hover {
    color: var(--neo-violet, var(--sapHighlightColor, #0070f2));
    background: color-mix(in srgb, var(--neo-violet, var(--neo-violet, #7c3aed)) 12%, var(--sapButton_Hover_Background, transparent));
    box-shadow:
      inset 0 0 0 1px color-mix(in srgb, var(--neo-cyan, #00b4d8) 35%, transparent),
      0 0 12px color-mix(in srgb, var(--neo-cyan, #00b4d8) 18%, transparent);
  }
